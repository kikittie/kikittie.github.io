...
function loadEmojis(){
	...
	$('body :not(script, iframe)').contents().filter(function() {
		...
		for(var i = 0; i < emojis.length; ++i){
			...
			var img = '<img src="https://raw.githubusercontent.com/kikittie/kikittie.github.io/main/img/'+emojis[i]+'.png" style="user-drag: none; -webkit-user-drag: none; user-select: none; -moz-user-select: none; -webkit-user-select: none; -ms-user-select: none;"></img>';
